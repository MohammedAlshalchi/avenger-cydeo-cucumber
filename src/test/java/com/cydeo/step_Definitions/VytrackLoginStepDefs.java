...
import com.cydeo.pages.VytracLoginPage;
...
public class VytrackLoginStepDefs {
    VytracLoginPage loginPage = new VytracLoginPage();
...
public void user_is_on_the_login_page() {
    ...
    public void user_should_be_able_to_see_as_title(String expectedTitle) {
